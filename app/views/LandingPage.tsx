	...
	return (
		<main className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black text-white">
			...
			<div className="relative z-10 my-auto flex w-full flex-col items-center">
				{/* HEADER */}
				<header className="mt-8 shrink-0 text-center sm:mt-0">
				...
				{/* THE FOUR LIBRARIES */}
				<div className="mt-6 grid w-full max-w-425 grid-cols-1 gap-5 px-4 sm:mt-10 sm:grid-cols-2 sm:gap-6 sm:px-6 lg:grid-cols-4">
							...
							>
								...
								<div className="-mt-1 hidden sm:block">
									{recent && recent.length > 0 ? (
										...
										isLoading && !recent && <RecentSkeleton />
									)}
								</div>
							</section>
						);
